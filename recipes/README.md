...
| [`moonshotai/Kimi-Audio-7B-Instruct.md`](./moonshotai/Kimi-Audio-7B-Instruct.md) | Offline-inference for ASR, single-turn audio chat, and multi-turn audio chat | 1x RTX PRO 6000 Blackwell |
