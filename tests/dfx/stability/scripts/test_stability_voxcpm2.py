"""
VoxCPM2 stability: OmniServer + ``vllm bench serve --omni`` for a fixed duration.

Configuration: ``tests/dfx/stability/tests/test_voxcpm2.json``.
"""
...
CONFIG_FILE_PATH = str(STABILITY_DIR / "tests" / "test_voxcpm2.json")
...
def test_stability_voxcpm2(omni_server, stability_benchmark_params):
