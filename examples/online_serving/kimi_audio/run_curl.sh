...
#
# Server launch:
#   audio2text  -> kimi_audio.yaml
#   audio2audio -> kimi_audio_audio_out.yaml (or kimi_audio_async_chunk.yaml)
#   text2audio  -> kimi_audio_audio_out.yaml (or kimi_audio_async_chunk.yaml)
set -euo pipefail
