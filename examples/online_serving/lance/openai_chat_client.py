#!/usr/bin/env python3
"""
Lance OpenAI-compatible chat client for image generation and multimodal tasks.

Usage:
    python examples/online_serving/lance/openai_chat_client.py --prompt "A cute cat" --output output.png
    python examples/online_serving/lance/openai_chat_client.py --prompt "Describe this image" --image-url https://example.com/image.png
"""
